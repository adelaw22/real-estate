          ...
          <div className='formAddress'>
            <Form>
              <Responsive minWidth={768}>
                ...
                >
                  <Form.Input label='Name' placeholder='Jane Doe' required />
                  <Form.Input label='Address' placeholder='Resident Address' />
                </Form.Group>
            ...
            <div className='AddressInText'>
              ...
              <p>
                ...
                lacinia ullamcorper rhoncus.pellentesque rhoncus libero nec
                ipsum egestas aliquam.{" "}
              </p>
              <p className='phead'> Address </p>
